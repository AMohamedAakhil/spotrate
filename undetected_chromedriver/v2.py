...
def get_chrome_user_data_dir():
    # Get the platform (Windows, macOS, or Linux)
    platform = sys.platform
    if platform == "win32":
        # Windows
        local_app_data = os.environ["LOCALAPPDATA"]
        chrome_user_data_dir = os.path.join(local_app_data, "Google", "Chrome", "User Data")
        ...
        home_dir = os.path.expanduser("~")
        chrome_user_data_dir = os.path.join(home_dir, ".config", "google-chrome")
